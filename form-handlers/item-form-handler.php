...
if (isset($_POST['title'], $_POST['color'], $_POST['condID'], $_POST['item_desc'], $_POST['brandID'], $_POST['sellerID'], $_POST['price'], $_POST['date_added'])) {
    ...
    $itemModel->addItem($title, $color, $condid, $desc, $brandid, $sellerid, $price, $dateadded);
