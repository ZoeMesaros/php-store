...
if (isset($_POST['title'], $_POST['color'], $_POST['brandID'], $_POST['sellerID'], $_POST['price'], $_POST['date_added'])) {
    ...
    $itemModel->addItem($title, $color, $brandid, $sellerid, $price, $dateadded);
